...
class TestInterviewRecord:
    ...
    @pytest.mark.parametrize(("name", "label"), analyze_file("record_data", "test_interview_record"))
    def test_interview_record(self, name, label):
        self.page.local_record_page.click_interview()
        for i in range(3):
            time.sleep(602)
