...
class TestLockAndUnlockDuringRecordingChineseInTranslateMode:
    def setup(self):
    ...
    # 在主屏进入边录边译，在中文录音过程中，锁屏并解锁，查看转写和翻译内容
    @pytest.allure.severity(pytest.allure.severity_level.CRITICAL)
    def test_lock_and_unlock_during_recording_chinese_in_translate_mode(self):
