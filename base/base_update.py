...
class Base:
    ...
    def __init__(self, logger, driver=None):
        ...
        self.t = 0.5
        self.logger = logger
        self.path_imlocator = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'pages', 'locators',
                                           'images')
    ...
    def find_element(self, locator, driver=None, timeout=None):
        ...
        try:
            element = WebDriverWait(driver, timeout or self.timeout, self.t).until(
    ...
    def is_elementValue_contains_value(self, locator, value='', driver=None):
        ...
        driver = self._get_driver(driver)
        try:
            result = WebDriverWait(driver, self.timeout, self.t).until(
